...
if (updatePasswordBtn) {
  updatePasswordBtn.addEventListener('submit', function (e) {
    e.preventDefault();
    var passOld = document.getElementById('password-current').value;
    var passNew = document.getElementById('password').value;
    var passNewRepaet = document.getElementById('password-confirm').value;
    (0, _updateSettings.updatePassword)(passOld, passNew, passNewRepaet);
  });
}
