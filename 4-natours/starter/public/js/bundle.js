...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYWxlbnMiLCJhIjoiY2tidjh2Njd6MDEwZDMwbGJzMmk0MWtrdiJ9.zAveTuz4GeXr-3-79kTKbQ';
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Logged in uspješno'); // alert('Logged in uspješno');
          ...
          case 8:
            ...
            (0, _alerts.showAlert)('Neuspješno logiranje', _context.t0);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              console.log('logout success'); // location.reload(true)
...
var updatePassword = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(passOld, passNew, passNewRepaet) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 8:
            ...
            _context2.t0 = _context2["catch"](1);
            // showAlert('error', 'Update nije uspio');
            console.log(_context2.t0, 'Update nije uspio');
...
console.log(mapBox, userDataForm, loginForm, logOutBtn, _updateSettings.updatePassword);
...
if (updatePasswordBtn) {
  updatePasswordBtn.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      var passOld, passNew, passNewRepaet;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              passOld = document.getElementById('password-current').value;
              passNew = document.getElementById('password').value;
              passNewRepaet = document.getElementById('password-confirm').value;
              _context.next = 7;
              return (0, _updateSettings.updatePassword)(passOld, passNew, passNewRepaet);
